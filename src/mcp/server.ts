...
import fs from "fs";
import os from "os";
import { openDatabase, searchFts, closeDatabase, countEntries } from "../db";
...
import { writeMemorySynthesis } from "../synthesis";
    ...
    this.server.registerTool(
      ...
      async (args: any) => {
        ...
        try {
          ...
          const results = searchFts(db, query, config.retrieval?.max_memory_results ?? 10);
          return {
            content: [
              {
                type: "text" as const,
