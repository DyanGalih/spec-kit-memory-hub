...
- the current extension version is `0.5.2`
...
specify extension add memory-md --from https://github.com/DyanGalih/spec-kit-memory-hub/archive/refs/tags/v0.5.2.zip

The install example above works only after the `v0.5.2` release tag is published.
