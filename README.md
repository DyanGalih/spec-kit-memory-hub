...
[![Version](https://img.shields.io/badge/version-0.9.6-22c55e)](extension.yml)
...
```bash
specify extension add memory-md --from https://github.com/DyanGalih/spec-kit-memory-hub/archive/refs/tags/v0.9.6.zip
```
